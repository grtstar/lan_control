...
class AppRoomProperties(object):
    __slots__ = ["roomId", "enable", "cleanOrder", "cleanRepeart", "mopRepeat", "colorOrder", "donotSweep", "donotMop", "fanPower", "waterLevel", "enableYMop"]

    __typenames__ = ["int16_t", "int8_t", "int16_t", "int16_t", "int16_t", "int8_t", "int8_t", "int8_t", "int32_t", "int32_t", "int8_t"]
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">hbhhhbbbiib", self.roomId, self.enable, self.cleanOrder, self.cleanRepeart, self.mopRepeat, self.colorOrder, self.donotSweep, self.donotMop, self.fanPower, self.waterLevel, self.enableYMop))
    ...
    def _decode_one(buf):
        ...
        self.roomId, self.enable, self.cleanOrder, self.cleanRepeart, self.mopRepeat, self.colorOrder, self.donotSweep, self.donotMop, self.fanPower, self.waterLevel, self.enableYMop = struct.unpack(">hbhhhbbbiib", buf.read(21))
        return self
    _decode_one = staticmethod(_decode_one)

    def _get_hash_recursive(parents):
        if AppRoomProperties in parents: return 0
        tmphash = (0x9eed3ebf8c2411b8) & 0xffffffffffffffff
