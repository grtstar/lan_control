...
class AppSetRoomProperties(object):
    __slots__ = ["version", "count", "roomId", "enable", "fan", "waterLevel", "yMop", "cleanRepeat"]

    __typenames__ = ["int8_t", "int8_t", "int8_t", "int8_t", "int32_t", "int32_t", "int8_t", "int8_t"]

    __dimensions__ = [None, None, ["count"], ["count"], ["count"], ["count"], ["count"], ["count"]]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>%db' % self.count, *self.enable[:self.count]))
    ...
    def _decode_one(buf):
        ...
        self.enable = struct.unpack('>%db' % self.count, buf.read(self.count))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x50e166302fc38eed) & 0xffffffffffffffff
