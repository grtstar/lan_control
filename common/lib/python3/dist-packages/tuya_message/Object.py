...
class Object(object):
    ...
    __typenames__ = ["int32_t", "tuya_message.Grid2d", "string", "int8_t"]

    __dimensions__ = [None, None, None, None]

    def __init__(self):
        self.id = 0
        self.pos = tuya_message.Grid2d()
        self.type = ""
        self.rate = 0
    ...
    def _encode_one(self, buf):
        ...
        assert self.pos._get_packed_fingerprint() == tuya_message.Grid2d._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.pos = tuya_message.Grid2d._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x7cfef9e87980afbd+ tuya_message.Grid2d._get_hash_recursive(newparents)) & 0xffffffffffffffff
