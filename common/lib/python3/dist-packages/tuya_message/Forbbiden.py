...
class Forbbiden(object):
    ...
    __typenames__ = ["int8_t", "tuya_message.Line2d", "int8_t", "tuya_message.Rect2d", "int32_t", "int8_t", "tuya_message.Rect2d", "int32_t"]
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.lineCount):
            assert self.wall[i0]._get_packed_fingerprint() == tuya_message.Line2d._get_packed_fingerprint()
            self.wall[i0]._encode_one(buf)
        buf.write(struct.pack(">b", self.areaCount))
        for i0 in range(self.areaCount):
            assert self.area[i0]._get_packed_fingerprint() == tuya_message.Rect2d._get_packed_fingerprint()
        ...
        for i0 in range(self.mopCount):
            assert self.mop[i0]._get_packed_fingerprint() == tuya_message.Rect2d._get_packed_fingerprint()
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xf6b339b198f60059+ tuya_message.Line2d._get_hash_recursive(newparents)+ tuya_message.Rect2d._get_hash_recursive(newparents)+ tuya_message.Rect2d._get_hash_recursive(newparents)) & 0xffffffffffffffff
