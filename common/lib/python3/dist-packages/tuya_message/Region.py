...
class Region(object):
    ...
    __typenames__ = ["string", "int8_t", "int8_t", "tuya_message.Rect2d"]
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x23955c917fa0f828+ tuya_message.Rect2d._get_hash_recursive(newparents)) & 0xffffffffffffffff
