...
class ZoneState(object):
    ...
    __typenames__ = ["tuya_message.Rect2d", "int8_t"]

    __dimensions__ = [None, None]

    def __init__(self):
        self.clean = tuya_message.Rect2d()
        self.state = 0
    ...
    def _encode_one(self, buf):
        assert self.clean._get_packed_fingerprint() == tuya_message.Rect2d._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        self = ZoneState()
        self.clean = tuya_message.Rect2d._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x590f8388512c0c1f+ tuya_message.Rect2d._get_hash_recursive(newparents)) & 0xffffffffffffffff
