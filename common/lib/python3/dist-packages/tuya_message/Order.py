...
class Order(object):
    __slots__ = ["orderId", "sign", "valid", "hour", "minute", "mode", "cleanNum", "fan", "waterTank", "regionCount", "regions", "mopMode", "washWorkType", "wipeMode", "conflictType"]

    __typenames__ = ["int8_t", "int32_t", "int8_t", "int8_t", "int8_t", "int8_t", "int8_t", "int8_t", "int8_t", "int8_t", "int8_t", "int8_t", "int8_t", "int8_t", "int8_t"]

    __dimensions__ = [None, None, None, None, None, None, None, None, None, None, ["regionCount"], None, None, None, None]
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">bibbbbbbbb", self.orderId, self.sign, self.valid, self.hour, self.minute, self.mode, self.cleanNum, self.fan, self.waterTank, self.regionCount))
    ...
    def _decode_one(buf):
        self = Order()
        self.orderId, self.sign, self.valid, self.hour, self.minute, self.mode, self.cleanNum, self.fan, self.waterTank, self.regionCount = struct.unpack(">bibbbbbbbb", buf.read(13))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xf0d9cad6bebacd0e) & 0xffffffffffffffff
