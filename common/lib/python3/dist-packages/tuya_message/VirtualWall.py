...
class VirtualWall(object):
    ...
    __typenames__ = ["tuya_message.Grid2d", "tuya_message.Grid2d"]

    __dimensions__ = [None, None]

    def __init__(self):
        self.start = tuya_message.Grid2d()
        self.end = tuya_message.Grid2d()
    ...
    def _encode_one(self, buf):
        assert self.start._get_packed_fingerprint() == tuya_message.Grid2d._get_packed_fingerprint()
        self.start._encode_one(buf)
        assert self.end._get_packed_fingerprint() == tuya_message.Grid2d._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        self = VirtualWall()
        self.start = tuya_message.Grid2d._decode_one(buf)
        self.end = tuya_message.Grid2d._decode_one(buf)
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x96dcacf370554cc3+ tuya_message.Grid2d._get_hash_recursive(newparents)+ tuya_message.Grid2d._get_hash_recursive(newparents)) & 0xffffffffffffffff
