...
class RectAreas(object):
    ...
    __typenames__ = ["int8_t", "tuya_message.RectArea"]
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.count):
            assert self.area[i0]._get_packed_fingerprint() == tuya_message.RectArea._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.area = []
        for i0 in range(self.count):
            self.area.append(tuya_message.RectArea._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x6a317762cd552654+ tuya_message.RectArea._get_hash_recursive(newparents)) & 0xffffffffffffffff
