...
import tuya_message.RegionCleans

class RegionCleansSet(object):
    __slots__ = ["mapSign", "clean"]

    __typenames__ = ["int32_t", "tuya_message.RegionCleans"]

    __dimensions__ = [None, None]

    def __init__(self):
        self.mapSign = 0
        self.clean = tuya_message.RegionCleans()
    ...
    def _encode_one(self, buf):
        ...
        assert self.clean._get_packed_fingerprint() == tuya_message.RegionCleans._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.clean = tuya_message.RegionCleans._decode_one(buf)
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x2c8dc616a9b5dc60+ tuya_message.RegionCleans._get_hash_recursive(newparents)) & 0xffffffffffffffff
