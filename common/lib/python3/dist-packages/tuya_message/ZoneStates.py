...
import tuya_message.ZoneState

class ZoneStates(object):
    __slots__ = ["mapSign", "count", "zoneState"]

    __typenames__ = ["int32_t", "int8_t", "tuya_message.ZoneState"]
    ...
    def __init__(self):
        self.mapSign = 0
        self.count = 0
        self.zoneState = tuya_message.ZoneState()
    ...
    def _encode_one(self, buf):
        ...
        assert self.zoneState._get_packed_fingerprint() == tuya_message.ZoneState._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.zoneState = tuya_message.ZoneState._decode_one(buf)
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x5f925268e9029705+ tuya_message.ZoneState._get_hash_recursive(newparents)) & 0xffffffffffffffff
