...
class RegionSplit(object):
    ...
    __typenames__ = ["int8_t", "tuya_message.Line2d"]

    __dimensions__ = [None, None]

    def __init__(self):
        self.regionNum = 0
        self.line = tuya_message.Line2d()
    ...
    def _encode_one(self, buf):
        ...
        assert self.line._get_packed_fingerprint() == tuya_message.Line2d._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.line = tuya_message.Line2d._decode_one(buf)
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x84a3a603aa1797b8+ tuya_message.Line2d._get_hash_recursive(newparents)) & 0xffffffffffffffff
