...
class RoomPropety
{
    ...
    public:
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(RoomPropety, roomNo, roomArea, roomName, enable, cleanOrder, cleanRepeat, mopRepeat, colorOrder, donotSweep, donotMop, fanPower, waterLevel, enableYMop)
#endif
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(RoomPropety, roomNo, roomArea, roomName, enable, cleanOrder, cleanRepeat, mopRepeat, colorOrder, donotSweep, donotMop, fanPower, waterLevel, enableYMop)
#endif
    public:
        bool operator==(const RoomPropety& other) const
        {
            return roomNo == other.roomNo && roomArea == other.roomArea && roomName == other.roomName && enable == other.enable && cleanOrder == other.cleanOrder && cleanRepeat == other.cleanRepeat && mopRepeat == other.mopRepeat && colorOrder == other.colorOrder && donotSweep == other.donotSweep && donotMop == other.donotMop && fanPower == other.fanPower && waterLevel == other.waterLevel && enableYMop == other.enableYMop;
        }
    public:
        /**
...
uint64_t RoomPropety::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x1aa4786409ec1e95LL +
